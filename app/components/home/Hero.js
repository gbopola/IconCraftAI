    ...
    <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl pt-32">
          <div className="text-center">
            ...
            Craft stunning icons with a simple click.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Streamline your workflow and enhance your brand presence – effortlessly generate icons for your business website, applications, or brand using our cutting-edge AI digital icon generator.
            </p>
