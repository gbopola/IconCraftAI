      ...
      <div className="mx-auto max-w-2xl pt-32">
        <div className="text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Streamline your workflow and enhance your brand presence –
            effortlessly generate icons for your business website, applications,
            or brand using our cutting-edge AI digital icon generator.
          </p>
